...
export sem=$( curl -s https://raw.githubusercontent.com/afiqdev/scfreev1/main/test/versions)
...
echo -e "${CYAN}============================================================\033[0m${NC}"
echo -e "${BICyan} "                                                                      
echo -e "${BICyan} ⇲  ${BICyan}Use Core        :  ${BIYellow}TUNNELING "    
...
echo -e " ${RED}"
echo -e "${CYAN}============================================================\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ TUNNELING  ⇲                    \E[0m"
echo -e "${CYAN}============================================================\033[0m${NC}"
echo
...
21) clear ; clearlog ;;
#99) clear ; update ;;
22) clear ; wget https://raw.githubusercontent.com/afiqdev/scfreev1/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
